...
export function DataTableestabelecimentopenal<TData, TValue>({
  columns,
  ...
  return (
    ...
    <div className="w-400">
      ...
      <a className=" text-[24px] font-sans font-bold"> Buscar Estabelecimento Penal  </a>
      
      <div className="flex justify-end items-center gap-x-4">
       
         <Button className="bg-green-900 text-white" onClick={() => router.push(" /estabelecimentopenal/cadastrar")}>
